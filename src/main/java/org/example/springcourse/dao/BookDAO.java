...
public class BookDAO {
    ...
    public void save(Book book){
        jdbcTemplate.update("INSERT INTO Book(person_id, name, author, year) VALUES (?, ?, ?, ?)", book.getPerson_id(), book.getName(), book.getAuthor(), book.getYear());
    }

    public void update(int id, Book book){
        jdbcTemplate.update("UPDATE Book set person_id=?, name=?, author=?, year=? where book_id=?", book.getPerson_id(), book.getName(), book.getAuthor(), book.getYear(), id);
    }
